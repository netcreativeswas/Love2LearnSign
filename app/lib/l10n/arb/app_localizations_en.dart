...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get notificationLearnWordTitle => 'Learn a word today!';
  ...
  String shareText(Object score, Object total) {
    return 'I scored $score/$total in the sign language quiz! 🤟 Can you beat me? Download Love to Learn Sign and learn Bangla Sign Language: https://yourapp.link';
  }
  ...
  String freeSessions(int remaining, int total) {
    return 'Free Sessions: $remaining/$total';
  }
}
