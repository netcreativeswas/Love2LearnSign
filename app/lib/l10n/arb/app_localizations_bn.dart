...
class AppLocalizationsBn extends AppLocalizations {
  ...
  @override
  String get notificationLearnWordTitle => 'আজ একটি শব্দ শিখুন!';
  ...
  String shareText(Object score, Object total) {
    return 'সাইন ভাষার কুইজে $score/$total পেয়েছি! 🤟 আপনি কি তা করতে পারবেন? Love to Learn Sign ডাউনলোড করুন এবংবাংলা সাইন ল্যাঙ্গুয়েজ শিখুন: https://yourapp.link';
  }
  ...
  String get privacyDialogPointAccount =>
      '• ব্যবহারকারী অ্যাকাউন্ট পরিচালনা করা (সাইন-ইন/সাইন-আপের জন্য ইমেইল)';
  ...
  String get privacyDialogPointCaching =>
      '• অফলাইন দেখার জন্য ভিডিও কন্টেন্ট লোকালি সেভ করুন';

  @override
  String get privacyDialogPointTracking =>
      '• বৈশিষ্ট্য উন্নত করতে ব্যবহার ট্র্যাক করা (ভিডিও ভিউ, গেম সেশন)';

  @override
  String get privacyDialogPointSearchAnalytics =>
      '• অভিধান সার্চের তথ্য বেনামে লগ করা হয় (শব্দ, বিভাগ, ফলাফলের সংখ্যা, পাওয়া/না-পাওয়া) যাতে নতুন কনটেন্ট উন্নত করা যায় — কোনো ব্যবহারকারীর আইডি সংরক্ষণ করা হয় না';

  @override
  String get privacyDialogPointImprove => '• অ্যাপ এবং তার বৈশিষ্ট্য উন্নত করা';
  ...
  String get privacyDialogThirdPartyAdmob =>
      '• Google Mobile Ads (AdMob) - বিজ্ঞাপন প্রদর্শন এবং ট্র্যাকিং';
  ...
  String get privacyDialogRightsAccess =>
      '• অ্যাপ সেটিংসের মাধ্যমে আপনার ডেটা অ্যাক্সেস, পরিবর্তন বা মুছে ফেলুন';
  ...
  String get privacyDialogRightsAds =>
      '• ব্যক্তিগতকৃত বিজ্ঞাপন থেকে বের হতে Advertising ID রিসেট করুন';

  @override
  String get privacyDialogRightsDelete =>
      '• আমাদের সাথে যোগাযোগ করে ডেটা মুছে ফেলার অনুরোধ করুন';
  ...
  String get privacyDialogPremiumPayment =>
      '• পেমেন্ট ডেটা স্টোর প্ল্যাটফর্ম দ্বারা নিরাপদে প্রক্রিয়া করা হয়';

  @override
  String get privacyDialogPremiumNoCard =>
      '• আমরা আপনার পেমেন্ট কার্ড তথ্য সংরক্ষণ করি না';
  ...
  @override
  String get emailVerifiedSuccess => 'আপনার ই-মেইল সফলভাবে যাচাই করা হয়েছে।';

  @override
  String get accountPendingApprovalBody =>
      'আপনার ই-মেইল সফলভাবে যাচাই করা হয়েছে। আপনার অ্যাকাউন্ট এখন অ্যাডমিনিস্ট্রেটরের অনুমোদনের অপেক্ষায় রয়েছে। অ্যাডমিন আপনার অ্যাকাউন্ট অনুমোদন করার পর আপনি অ্যাক্সেস পাবেন।';
  ...
  String get nextAdminReview =>
      'একজন অ্যাডমিনিস্ট্রেটর আপনার অ্যাকাউন্ট পর্যালোচনা করবেন';

  @override
  String get nextRoleAssignment => 'আপনাকে উপযুক্ত ভূমিকা দেওয়া হবে';

  @override
  String get nextAccessAfterApproved => 'আপনি অ্যাপে সম্পূর্ণ অ্যাক্সেস পাবেন';

  @override
  String get returnToApp => 'অ্যাপে ফিরে যান';

  @override
  String get verifyStatusError => 'যাচাইকরণের অবস্থা পরীক্ষা করতে ত্রুটি';
  ...
  @override
  String get verifyEmailResentError => 'যাচাইকরণ ই-মেইল পুনরায় পাঠাতে ত্রুটি';

  @override
  String get verifyYourEmailTitle => 'আপনার ই-মেইল যাচাই করুন';

  @override
  String get verifyYourEmailHeadline =>
      'অনুগ্রহ করে আপনার ই-মেইল ঠিকানা যাচাই করুন';

  @override
  String get verifyEmailSentTo => 'একটি যাচাইকরণ ই-মেইল পাঠানো হয়েছে:';
  ...
  String get verifyEmailInfoBody =>
      'আমরা আপনার ই-মেইল ঠিকানায় একটি যাচাইকরণ লিঙ্ক পাঠিয়েছি। অনুগ্রহ করে আপনার ইনবক্স (এবং স্প্যাম ফোল্ডার) চেক করুন এবং আপনার অ্যাকাউন্ট যাচাই করতে লিঙ্কে ক্লিক করুন।';

  @override
  String get verifyEmailAutoRedirectHint =>
      'আপনার ই-মেইল যাচাই হওয়ার পর আপনি স্বয়ংক্রিয়ভাবে রিডাইরেক্ট হবেন।';
  ...
  String get checkingVerificationStatus =>
      'যাচাইকরণের অবস্থা পরীক্ষা করা হচ্ছে...';
  ...
  String get removeAdsUnlimitedAccess =>
      'বিজ্ঞাপন সরান এবং সীমাহীন অ্যাক্সেস পান';

  @override
  String get removeAllAdsForever =>
      'সমস্ত বিজ্ঞাপন সরিয়ে দিন — প্রিমিয়ামে আপগ্রেড করুন';
  ...
  @override
  String get monthlyLimitReached => 'মাসিক সীমা পূর্ণ';

  @override
  String get quizLimitReachedMessage =>
      'আপনি এই মাসে আপনার বিনামূল্যে কুইজ সেশন ব্যবহার করেছেন। 3টি অতিরিক্ত কুইজ সেশন আনলক করতে একটি সংক্ষিপ্ত বিজ্ঞাপন দেখুন।';

  @override
  String get flashcardLimitReachedMessage =>
      'আপনি এই মাসে আপনার বিনামূল্যে ফ্ল্যাশকার্ড সেশন ব্যবহার করেছেন। 3টি অতিরিক্ত ফ্ল্যাশকার্ড সেশন আনলক করতে একটি সংক্ষিপ্ত বিজ্ঞাপন দেখুন।';

  @override
  String get goPremiumUnlimited => 'সীমাহীন শেখার জন্য প্রিমিয়ামে যান';
  ...
  String get failedToLoadAd =>
      'বিজ্ঞাপন লোড করতে ব্যর্থ হয়েছে। অনুগ্রহ করে আবার চেষ্টা করুন।';

  @override
  String get watchAdCompletely => 'বিজ্ঞাপন সম্পূর্ণ দেখতে হবে রিওয়ার্ড পেতে।';

  @override
  String get premiumMember => 'আপনি প্রিমিয়াম সদস্য!';

  @override
  String get renews => 'নবায়ন তারিখ:';

  @override
  String get switchToYearlyPlan => 'বার্ষিক পরিকল্পনায় স্যুইচ করুন';

  @override
  String get saveMoreBestValue => 'সঞ্চয় করুন এবং সেরা মূল্য পান';

  @override
  String get premiumBenefits => 'প্রিমিয়াম সুবিধা';

  @override
  String get noAds => 'কোন বিজ্ঞাপন নেই';

  @override
  String get unlimitedQuiz => 'সীমাহীন কুইজ';

  @override
  String get unlimitedFlashcards => 'সীমাহীন ফ্ল্যাশকার্ড';
  ...
  @override
  String get upgradeInitiated => 'আপগ্রেড শুরু হয়েছে...';

  @override
  String get failedToInitiateUpgrade => 'আপগ্রেড শুরু করতে ব্যর্থ হয়েছে';
  ...
  @override
  String get unlimitedLearningAdFree => 'সীমাহীন শেখা, বিজ্ঞাপন ছাড়াই';

  @override
  String get noAdsDescription => 'সমস্ত বিজ্ঞাপন সরিয়ে দিন এবং বাধাহীন শিখুন';
  ...
  String get supportAppDescription =>
      'আমাদের সাইন ল্যাঙ্গুয়েজ ডিকশনারি উন্নয়নে সাহায্য করুন';

  @override
  String get purchaseInitiated => 'ক্রয় শুরু হয়েছে...';

  @override
  String get failedToInitiatePurchase => 'ক্রয় শুরু করতে ব্যর্থ হয়েছে';
  ...
  String get supportAppRemoveAds =>
      'অ্যাপ উন্নয়ন সমর্থন করুন এবং বিজ্ঞাপন ছাড়াই সীমাহীন শিখুন — প্রিমিয়ামে আপগ্রেড করুন।';

  @override
  String get viewPremium => 'প্রিমিয়াম দেখুন';

  @override
  String get aboutSectionTitle => 'সম্পর্কে';

  @override
  String get appVersionTitle => 'অ্যাপ সংস্করণ';

  @override
  String freeSessions(int remaining, int total) {
    return 'ফ্রি সেশন: $remaining/$total';
  }
}
