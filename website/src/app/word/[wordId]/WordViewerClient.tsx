  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      try {
        ...
        if (cancelled) return;
        const msg = e instanceof Error ? e.message : "Failed to load this word.";
        setError(msg);
        setConcept(null);
      } finally {
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3">
          <Link href="/" className="flex items-center gap-3 rounded-xl px-2 py-1 hover:bg-muted">
            ...
            <div className="min-w-0">
              ...
              <div className="truncate text-xs text-muted-foreground">Watch a sign</div>
            </div>
          </Link>
              ...
              <div className="box-border h-full rounded-3xl border border-border bg-surface p-4 shadow-sm sm:p-6">
                <div className="flex h-full flex-col gap-3">
                  <div className="flex-none">
                    <div className="text-sm font-semibold text-muted-foreground">Watch this sign</div>
                    {loading ? (
                    ...
                    <div className="relative h-[52dvh] w-full overflow-hidden rounded-2xl bg-muted sm:h-[58dvh] lg:h-full">
                      {loading ? (
                        ...
                        <div className="flex h-full items-center justify-center px-6 text-center">
                          <div>
                            <div className="text-sm font-semibold">Couldn’t load this word</div>
                        ...
                        <div className="flex h-full items-center justify-center px-6 text-center">
                          <div>
                            <div className="text-sm font-semibold">Word not found</div>
                        ...
                        <div className="flex h-full items-center justify-center px-6 text-center">
                          <div>
                            <div className="text-sm font-semibold">No video available</div>
                            <div className="mt-1 text-sm text-muted-foreground">
                              This word exists but has no video URL yet.
                            </div>
                          </div>
                        </div>
                      ) : (
